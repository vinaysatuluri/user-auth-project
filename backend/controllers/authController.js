...
export const sendOtpEmail = async (email, otp) => {
    try {
        ...
        const mailOptions = {
            ...
            text: `Your OTP code is ${otp}`, //  message
        };
...
export const signupHandler = async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            //  consider deleting the user record if OTP sending is critical.
...
export const verifyOtpHandler = async (req, res) => {
    ...
    try {
        ...
        if (purpose === 'signup') {
            // Update user to mark as verified and clear OTP details for signup
            await pool.query(
